...
export const NavbarLogo = () => {
	return (
		<a
			href="#"
			className="relative z-20 mr-4 flex items-center space-x-2 px-2 py-1 text-3xl font-normal text-black"
		>
			<span className="font-bold font-xl text-black dark:text-white">
				LLM Chess
			</span>
		</a>
	);
